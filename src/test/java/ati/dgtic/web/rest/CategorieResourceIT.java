...
import ati.dgtic.domain.Categorie;
import ati.dgtic.repository.CategorieRepository;
...
public class CategorieResourceIT {
    ...
    private static final String DEFAULT_CODE_CATEGORIE = "AAAAAAAAAA";
    private static final String UPDATED_CODE_CATEGORIE = "BBBBBBBBBB";
    ...
    public void createCategorie() throws Exception {
        ...
        assertThat(testCategorie.getCodeCategorie()).isEqualTo(DEFAULT_CODE_CATEGORIE);
    ...
    @Test
    @Transactional
    public void checkCodeCategorieIsRequired() throws Exception {
    ...
    public void getAllCategories() throws Exception {
        ...
        restCategorieMockMvc.perform(get("/api/categories?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].codeCategorie").value(hasItem(DEFAULT_CODE_CATEGORIE)))
    ...
    public void getCategorie() throws Exception {
        ...
        restCategorieMockMvc.perform(get("/api/categories/{id}", categorie.getId()))
            ...
            .andExpect(jsonPath("$.codeCategorie").value(DEFAULT_CODE_CATEGORIE))
    ...
    public void updateCategorie() throws Exception {
        ...
        Categorie testCategorie = categorieList.get(categorieList.size() - 1);
        assertThat(testCategorie.getCodeCategorie()).isEqualTo(UPDATED_CODE_CATEGORIE);
