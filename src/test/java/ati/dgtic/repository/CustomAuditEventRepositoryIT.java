...
import ati.dgtic.config.audit.AuditEventConverter;
import ati.dgtic.domain.PersistentAuditEvent;
...
import static ati.dgtic.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
