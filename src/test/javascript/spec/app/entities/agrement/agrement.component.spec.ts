...
import { AgrementComponent } from 'app/entities/agrement/agrement.component';
...
describe('Component Tests', () => {
  describe('Agrement Management Component', () => {
    let comp: AgrementComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(AgrementComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.agrements && comp.agrements[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
