...
/**
 * REST controller for managing {@link ati.dgtic.domain.Qualification}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class QualificationResource {
    ...
    public ResponseEntity<Qualification> updateQualification(@Valid @RequestBody Qualification qualification) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, qualification.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<List<Qualification>> getAllQualifications(Pageable pageable) {
