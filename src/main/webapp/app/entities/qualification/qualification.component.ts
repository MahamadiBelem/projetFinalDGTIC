...
export class QualificationComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.qualificationService
      ...
      .subscribe(
        (res: HttpResponse<IQualification[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInQualifications(): void {
    this.eventSubscriber = this.eventManager.subscribe('qualificationListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IQualification[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
